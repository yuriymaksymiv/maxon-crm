...
<head>
    ...
    <script src="{{ asset('dashboard/bootstrap/js/bootstrap.min.js') }}" defer></script>
    <script src="{{ asset('dashboard/js/sb-admin-2.js') }}" defer></script>
    <!-- Metis Menu Plugin JavaScript -->
    <script src="{{ asset('dashboard/metisMenu/metisMenu.min.js') }}" defer></script>
    <!-- Morris Charts JavaScript -->
    <script src="{{ asset('dashboard/raphael/raphael.min.js') }}" defer></script>
    <script src="{{ asset('dashboard/morrisjs/morris.min.js') }}" defer></script>
    <script src="{{ asset('dashboard/data/morris-data.js') }}" defer></script>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                   <li>
                        <a href="/office"><i class="fa fa-dashboard fa-fw"></i>Статистика</a>
                    </li>
                    <li>
